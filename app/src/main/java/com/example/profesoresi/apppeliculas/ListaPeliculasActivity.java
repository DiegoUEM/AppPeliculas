package com.example.profesoresi.apppeliculas;
...
import com.example.profesoresi.apppeliculas.recyclerUtils.AdaptadorPeliculas;
import com.example.profesoresi.apppeliculas.retrofitUtils.RestServicePeliculas;
import com.example.profesoresi.apppeliculas.retrofitUtils.RetrofitClient;
        ...
        ap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /*Intent i = new Intent(ListaPeliculasActivity.this,
                        x.class);
                i.putExtra(getResources().getString(R.string.clave_cod_pokemon),
                        pr.getCodigo());
                startActivity(i);*/
            }
        });
